...
echo 'import { BottomTabStackNavigatorParams } from "@navigation/bottom-tab-navigation";' >> "${input_name}.tsx"
echo '' >> "${input_name}.tsx"
...
echo '    navigation: StackNavigationProp<BottomTabStackNavigatorParams, "'${component_name}'">;' >> "${input_name}.tsx"
echo '};' >> "${input_name}.tsx"
echo '' >> "${input_name}.tsx"
echo 'const '${component_name}': FC<'${component_name}'Props> = () => {' >> "${input_name}.tsx"
echo '    return <View style={styles.container}></View>;' >> "${input_name}.tsx"
echo '};' >> "${input_name}.tsx"
echo '' >> "${input_name}.tsx"
