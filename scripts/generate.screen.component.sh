...
echo 'import { StackNavigatorParams } from "@navigation/main-navigator";' >> "${input_name}.tsx"
echo '' >> "${input_name}.tsx"
echo '// styles' >> "${input_name}.tsx"
echo 'import styles from "./'${input_name}'.styles";' >> "${input_name}.tsx"
echo '' >> "${input_name}.tsx"
echo '// theme' >> "${input_name}.tsx"
echo 'import { AppStyle } from "@theme/theme";' >> "${input_name}.tsx"
echo '' >> "${input_name}.tsx"
echo '// components' >> "${input_name}.tsx"
echo 'import { Text } from "@atoms";' >> "${input_name}.tsx"
echo '' >> "${input_name}.tsx"
...
echo '        <View style={[styles.container, AppStyle["flex-center"]]}>' >> "${input_name}.tsx"
